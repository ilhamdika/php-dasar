	...
	<table border="1" cellpadding="10" cellspacing="0">
		...
		<?php foreach ($mahasiswa as $row) : ?>
			...
			<tr>
				...
				<td><img src="img/<?php echo $row["gambar"]; ?>" width="50" style= "border-radius: 50px;"></td>
				<td><?php echo $row["nrp"]; ?></td>
				<td><?php echo $row["nama"]; ?></td>
				<td><?php echo $row["email"]; ?></td>
				<td><?php echo $row["jurusan"]; ?></td>
				<td >
					<a href="https://api.whatsapp.com/send?phone=<?php echo	$row["no_wa"]; ?>"><img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/WhatsApp_icon.png" style="max-height:50px;"></a>
				</td>
